              ...
              <div class="demo-img-userPhoto" v-if="pic_area_h">
                <div style="position: relative;">
                  <div style="position: absolute;" v-if="show_warning">
                    <img src="../assets/003.gif" style="width: 100px; margin-top: 510px; margin-left: 520px"/>
                  </div>
            ...
            <el-col :span="14">
              <div class="grid-content-userInfo bg-purple-dark-userInfo">
                <div class="demo-button-signInOut" style="margin-top: 10px;">
                  <el-button type="primary" style="margin: 5px" @click.prevent="start_detc()">检测(安全帽)</el-button>
...
export default {
  ...
  methods: {
    ...
    runSocket() {
      this.ws = new WebSocket("ws://10.20.40.36:5679/");
      // this.ws = new WebSocket("ws://10.20.50.163:5679/");
      // this.ws = new WebSocket("ws://10.20.40.68:5679/");
